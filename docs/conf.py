# -*- coding: utf-8 -*-
#
# pyplate documentation build configuration file, created by
...
autodoc_mock_imports = ['numpy', 'scipy', 'statsmodels', 'astropy', 'ephem']
...
project = u'PyPlate'
copyright = u'2021, Taavi Tuvikene'
...
epub_copyright = u'2021, Taavi Tuvikene'
